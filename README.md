...
|------|-------|-------------|-------|-----|------|----------|
| CTV Playground | [Site](https://ctv-playground.com),<br> | Web-based tool for experimenting with CTV scripts and transaction templates | Prototype | ✓ | | Learning CTV concepts, testing script constructions, visualizing transaction templates |
