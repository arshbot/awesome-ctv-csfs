...
| Minsc | [Site](https://minsc-lang.org),<br>[v0.3](https://min.sc/v0.3),<br> | High-level scripting language for Bitcoin contracts with CTV support | Production | ✓ | | Policy development, script compilation, address generation, contract testing |
